...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String) -> Int {
        ...
        nextIndex = userChoice == stories[storyNumber].choice1 ? stories[storyNumber].choice1Destination : stories[storyNumber].choice2Destination
        
        self.storyNumber = nextIndex
